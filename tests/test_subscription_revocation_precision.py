...
def test_migration_is_based_on_current_dev_head():
    assert migration.down_revision == "8e2f1a9c4b70"
    assert "Apply this migration before deploying code that issues v5 tokens" in migration.__doc__
