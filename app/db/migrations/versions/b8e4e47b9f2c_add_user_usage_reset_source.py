...
def upgrade() -> None:
    ...
    # upgrade may represent manual, scheduled, or next-plan resets.  Do not guess: treating them as
    ...
    # The server default backfills existing rows and protects old writers.
    # Do not overwrite explicit sources from a new writer during the upgrade.
