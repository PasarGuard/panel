...
def upgrade() -> None:
    ...
    with op.batch_alter_table('node_usages', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_node_usages_created_at'), ['created_at', 'node_id'])

    with op.batch_alter_table('node_user_usages', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_node_user_usages_created_at'), ['created_at', 'user_id', 'node_id'])

    with op.batch_alter_table('nodes', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_nodes_name'), ['name'])

    with op.batch_alter_table('user_templates', schema=None) as batch_op:
        batch_op.create_unique_constraint(batch_op.f('uq_user_templates_name'), ['name'])
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('user_templates', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_user_templates_name'), type_='unique')

    with op.batch_alter_table('nodes', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_nodes_name'), type_='unique')

    with op.batch_alter_table('node_user_usages', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_node_user_usages_created_at'), type_='unique')

    with op.batch_alter_table('node_usages', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('uq_node_usages_created_at'), type_='unique')
