...
def upgrade() -> None:
    ...
    with op.batch_alter_table('hosts', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            'fk_hosts_inbound_tag_inbounds', 'inbounds', 
            ['inbound_tag'], ['tag'], onupdate='CASCADE', ondelete='SET NULL'
        )
    ...
    with op.batch_alter_table('next_plans', schema=None) as batch_op:
        ...
        if fk_np_temp: batch_op.drop_constraint(fk_np_temp, type_='foreignkey')
        if fk_np_user: batch_op.drop_constraint(fk_np_user, type_='foreignkey')
        batch_op.create_foreign_key('fk_next_plans_user_id_users', 'users', ['user_id'], ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key('fk_next_plans_user_template_id_user_templates', 'user_templates', ['user_template_id'], ['id'], ondelete='SET NULL')
    ...
    with op.batch_alter_table('node_usage_reset_logs', schema=None) as batch_op:
        ...
        if fk_nurl: batch_op.drop_constraint(fk_nurl, type_='foreignkey')
        batch_op.create_foreign_key('fk_node_usage_reset_logs_node_id_nodes', 'nodes', ['node_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('node_usages', schema=None) as batch_op:
        ...
        if fk_nu: batch_op.drop_constraint(fk_nu, type_='foreignkey')
    ...
    with op.batch_alter_table('node_user_usages', schema=None) as batch_op:
        ...
        if fk_nuu_node: batch_op.drop_constraint(fk_nuu_node, type_='foreignkey')
        if fk_nuu_user: batch_op.drop_constraint(fk_nuu_user, type_='foreignkey')
        batch_op.create_foreign_key('fk_node_user_usages_node_id_nodes', 'nodes', ['node_id'], ['id'], ondelete='CASCADE')
        batch_op.create_foreign_key('fk_node_user_usages_user_id_users', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('notification_reminders', schema=None) as batch_op:
        if fk_nr: batch_op.drop_constraint(fk_nr, type_='foreignkey')
        batch_op.create_foreign_key('fk_notification_reminders_user_id_users', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('user_subscription_updates', schema=None) as batch_op:
        if fk_usu: batch_op.drop_constraint(fk_usu, type_='foreignkey')
        batch_op.create_foreign_key('fk_user_subscription_updates_user_id_users', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    with op.batch_alter_table('user_usage_logs', schema=None) as batch_op:
        ...
        if fk_uul: batch_op.drop_constraint(fk_uul, type_='foreignkey')
        batch_op.create_foreign_key('fk_user_usage_logs_user_id_users', 'users', ['user_id'], ['id'], ondelete='CASCADE')
