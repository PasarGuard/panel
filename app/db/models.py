...
class User(Base, CreatedAtUTCMixin):
    ...
    _last_traffic_reset_at_query: Mapped[dt | None] = query_expression(repr=False)
    _last_cycle_traffic_reset_at_query: Mapped[dt | None] = query_expression(repr=False)
    ...
    def last_traffic_reset_at(self):
        if "_last_traffic_reset_at_query" in self.__dict__:
            return self._last_traffic_reset_at_query
    ...
    def last_cycle_traffic_reset_at(self):
        if "_last_cycle_traffic_reset_at_query" in self.__dict__:
            return self._last_cycle_traffic_reset_at_query
