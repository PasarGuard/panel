...
class SingBoxConfiguration(BaseSubscription):
    ...
    def _finalize_config(self):
        ...
        # A non-empty list is an operator-authored group and must survive.
        # Missing/null/[] retain the historical placeholder semantics and are
        # populated with the endpoints generated by the panel.
