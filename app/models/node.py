...
# Constants for reset_time validation
SECONDS_IN_DAY = 86400
SECONDS_IN_WEEK = 604800
SECONDS_IN_MONTH = 2419200  # 28 days to handle all months
...
class NodeModify(NodeCreate):
    ...
    reset_time: int | None = Field(default=None)
...
class NodeResponse(Node):
    ...
    data_limit: int | None = Field(default=None)
    lifetime_uplink: int = Field(default=0)
    lifetime_downlink: int = Field(default=0)
