  ...
  const handleSubmit = async (formData: HostFormValues) => {
    try {
      ...
      const hostData: CreateHost = {
        ...
        mihomo_ech_config: formData.mihomo_ech_config || undefined,
        mihomo_ech_query_server_name: formData.mihomo_ech_query_server_name || undefined,
        sing_box_ech_config: formData.sing_box_ech_config || undefined,
        sing_box_ech_query_server_name: formData.sing_box_ech_query_server_name || undefined,
