...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { resource: 'templates', action: 'read', scoped: true },
      { resource: 'templates', action: 'read_simple', scoped: true },
      { resource: 'templates', action: 'create' },
      { resource: 'templates', action: 'update', scoped: true },
      { resource: 'templates', action: 'delete', scoped: true },
