...
export default function HostsList({
  ...
  const handleEdit = (host: BaseHost) => {
    ...
    const formData: HostFormValues = {
      ...
      mihomo_ech_config: host.mihomo_ech_config || undefined,
      mihomo_ech_query_server_name: host.mihomo_ech_query_server_name || undefined,
      sing_box_ech_config: host.sing_box_ech_config || undefined,
      sing_box_ech_query_server_name: host.sing_box_ech_query_server_name || undefined,
