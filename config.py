...
NATS_ADMIN_AUTH_KV_BUCKET = config("NATS_ADMIN_AUTH_KV_BUCKET", default="pasarguard_admin_auth")
...
ADMIN_AUTH_CACHE_REFRESH_INTERVAL_SECONDS = config("ADMIN_AUTH_CACHE_REFRESH_INTERVAL_SECONDS", cast=int, default=600)
