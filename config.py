...
JOB_RECORD_USAGE_DB_CONCURRENCY = config("JOB_RECORD_USAGE_DB_CONCURRENCY", cast=int, default=3)
JOB_RECORD_USAGE_NODE_CONCURRENCY = config("JOB_RECORD_USAGE_NODE_CONCURRENCY", cast=int, default=20)
ONLINE_USERS_WINDOW_MINUTES = config("ONLINE_USERS_WINDOW_MINUTES", cast=int, default=2)
